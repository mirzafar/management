var FullCalendar = function(e) {
    ...
    ge.FullCalendarVDom ? console.warn("FullCalendar VDOM already loaded") : ge.FullCalendarVDom = {
        ...
        flushSync: function(e) {
            ...
            for (i.debounceRendering = function(e) {
                    n.push(e)
                }, L(v(me, {}), document.createElement("div")); n.length;) n.shift()();
    ...
    pu.prototype.classes = {
        ...
        popoverHeader: "popover-header",
        popoverContent: "popover-body"
    }, pu.prototype.baseIconClass = "bi", pu.prototype.iconClasses = {
        close: "bi-x-lg",
    ...
    }, pu.prototype.iconOverrideOption = "buttonIcons", pu.prototype.iconOverrideCustomButtonOption = "icon", pu.prototype.iconOverridePrefix = "bi-";
    var fu = Fo({
            themeClasses: {
                bootstrap5: pu
            }
    ...
    return Ci.push(js, vl, Ql, uu, du, fu, hu), e.BASE_OPTION_DEFAULTS = cn, e.BASE_OPTION_REFINERS = un, e.BaseComponent = Ao, e.BgEvent = os, e.BootstrapTheme = cu, e.Calendar = gs, e.CalendarApi = Tr, e.CalendarContent = aa, e.CalendarDataManager = Ti, e.CalendarDataProvider = Ui, e.CalendarRoot = ua, e.Component = Co, e.ContentHook = qo, e.CustomContentRenderContext = Go, e.DateComponent = Vo, e.DateEnv = Or, e.DateProfileGenerator = ri, e.DayCellContent = es, e.DayCellRoot = ns, e.DayGridView = fl, e.DayHeader = ya, e.DaySeriesModel = Sa, e.DayTable = pl, e.DayTableModel = ba, e.DayTableSlicer = dl, e.DayTimeCols = Yl, e.DayTimeColsSlicer = ql, e.DayTimeColsView = $l, e.DelayedRunner = wi, e.Draggable = Fs, e.ElementDragging = $i, e.ElementScrollController = So, e.Emitter = mo, e.EventApi = kr, e.EventRoot = Xa, e.EventSourceApi = ye, e.FeaturefulElementDragging = ks, e.Fragment = To, e.Interaction = Yi, e.ListView = iu, e.MoreLinkRoot = cs, e.MountHook = Zo, e.NamedTimeZoneImpl = function(e) {
        ...
        return r
    }, e.findElements = De, e.flexibleCompare = Ye, e.flushSync = Mo, e.formatDate = function(e, t) {
        void 0 === t && (t = {});
        var n = Br(t),
            r = ln(t),
    ...
    }, e.triggerDateSelect = gr, e.unmountComponentAtNode = Io, e.unpromisify = go, e.version = "5.11.3", e.whenTransitionDone = Ne, e.wholeDivideDurations = Wt, Object.defineProperty(e, "__esModule", {
        value: !0
    }), e
}({});
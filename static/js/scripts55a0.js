"use strict";
!function (u, p) {
    u.Package.name = "DashLite", u.Package.version = "3.2";
    var r = p(window), a = p("body"), c = p(document), t = "nk-menu", s = "nk-header-menu", l = "nk-sidebar",
        e = "nk-sidebar-mobile", d = u.Break;
    ...
    u.ClassBody = function () {
        ...
        u.BreakClass("." + s, d.lg, {timeOut: 0}), u.BreakClass("." + l, d.lg, {
            timeOut: 0,
            classAdd: e
        }), r.on("resize", function () {
            u.BreakClass("." + s, d.lg), u.BreakClass("." + l, d.lg, {classAdd: e})
        })
    }, u.Prettify = function () {
        window.prettyPrint && prettyPrint()
    }, u.Copied = function () {
        var t = ".clipboard-init", i = ".clipboard-text", o = "clipboard-success", s = "clipboard-error";

        function e(t, e) {
            var t = p(t), n = t.parent(), a = {text: "Copy", done: "Copied", fail: "Failed"},
    ...
    }, u.StickyNav = function () {
        var t = document.querySelectorAll(".nk-header");
        0 < t.length && t.forEach(function (t) {
            30 < window.scrollY ? t.classList.add("has-fixed") : t.classList.remove("has-fixed")
        })
    }, u.StickyNav.init = function () {
        u.StickyNav(), window.addEventListener("scroll", function () {
            u.StickyNav()
        })
        ...
        var a = "info" === (e = e || "info") ? "ni ni-info-fill" : "success" === e ? "ni ni-check-circle-fill" : "error" === e ? "ni ni-cross-circle-fill" : "warning" === e ? "ni ni-alert-fill" : "",
            i = {position: "bottom-right", ui: "", icon: "auto", clear: !1}, n = n ? f(i, n) : i;
        ...
        var t = p(t || ".toggle"), n = p("[data-content]"), o = !1,
            a = {active: "active", content: "content-active", break: !0}, s = e ? f(a, e) : a;
        u.TGL.screen(n), t.on("click", function (t) {
            o = this, u.Toggle.trigger(p(this).data("target"), s), t.preventDefault()
        }), c.on("mouseup", function (t) {
            var e, n, a, i;
            o && (e = p(o), n = p(o).data("target"), n = p('[data-content="'.concat(n, '"]')), a = p(".datepicker-dropdown"), i = p(".ui-timepicker-container"), e.is(t.target) || 0 !== e.has(t.target).length || n.is(t.target) || 0 !== n.has(t.target).length || 0 !== p(t.target).closest(".select2-container").length || a.is(t.target) || 0 !== a.has(t.target).length || i.is(t.target) || 0 !== i.has(t.target).length || (u.Toggle.removed(e.data("target"), s), o = !1))
        }), r.on("resize", function () {
            n.each(function () {
                var t = p(this).data("content"), e = p(this).data("toggle-screen"), e = d[e];
                u.Win.width > e && u.Toggle.removed(t, s)
            })
        })
    }, u.TGL.expand = function (t, e) {
        var t = t || ".expand", n = {toggle: !0}, a = e ? f(n, e) : n;
        p(t).on("click", function (t) {
            u.Toggle.trigger(p(this).data("target"), a), t.preventDefault()
        })
    }, u.TGL.ddmenu = function (t, e) {
        var t = t || ".nk-menu-toggle", n = {active: "active", self: "nk-menu-toggle", child: "nk-menu-sub"},
            a = e ? f(n, e) : n;
        p(t).on("click", function (t) {
            (u.Win.width < d.lg || p(this).parents().hasClass(l)) && u.Toggle.dropMenu(p(this), a), t.preventDefault()
        })
    }, u.TGL.showmenu = function (t, e) {
        var n = p(t || ".nk-nav-toggle"), a = p("[data-content]"), i = a.hasClass(s) ? d.lg : d.xl, t = {
        ...
        var n = {active: "active", timeout: 400, target: "[data-search]"}, a = e ? f(n, e) : n, i = p(t),
            o = p(a.target);
        i.exists() && (i.on("click", function (t) {
            t.preventDefault();
            var t = p(this).data("target"), e = p("[data-search=" + t + "]"), t = p("[data-target=" + t + "]");
        ...
        var n = {focus: "focused"}, a = e ? f(n, e) : n;
        p(t).exists() && p(t).each(function () {
            var t = p(this);
        ...
        p(t).exists() && (p(t).each(function () {
            var t = {errorElement: "span"}, t = e ? f(t, e) : t;
            p(this).validate(t)
        }), u.Validate.OnChange(".js-select2"), u.Validate.OnChange(".date-picker"), u.Validate.OnChange(".js-tagify"))
    }, u.Validate.OnChange = function (t) {
        p(t).on("change", function () {
            p(this).valid()
        })
        ...
        p(a).exists() && p(a).each(function () {
            var t = p(a).data("max-files") || null, e = p(a).data("max-file-size") || 256,
                n = p(a).data("accepted-files"),
                t = {autoDiscover: !1, maxFiles: t, maxFilesize: e, acceptedFiles: n || null}, e = i ? f(t, i) : t;
            p(this).addClass("dropzone").dropzone(e)
        })
        ...
        t.exists() && t.each(function () {
            var t = p(this).attr("id"), a = p("#" + t).show();
            a.steps({
        ...
        p(t).exists() && p(t).each(function () {
            var t = p(this).data("auto-responsive"), e = !(void 0 === o.buttons || !o.buttons),
                ...
                }, e = o ? f(a, o) : a, e = !1 === t ? f(e, {responsive: !1}) : e;
            p(this).DataTable(e), p(".dt-export-title").text(n)
        })
    }, u.DataTable.init = function () {
        u.DataTable(".datatable-init", {responsive: {details: !0}}), u.DataTable(".datatable-init-export", {
        ...
        p(t || ".dropdown-menu").on("click", function (t) {
            ...
            var t = p(this);
            t.hasClass("dropdown-menu-end") && !t.hasClass("dropdown-menu-center") ? t.prev('[data-bs-toggle="dropdown"]').dropdown({popperConfig: {placement: "bottom-start"}}) : t.hasClass("dropdown-menu-end") || t.hasClass("dropdown-menu-center") || t.prev('[data-bs-toggle="dropdown"]').dropdown({popperConfig: {placement: "bottom-end"}})
        })
    }, u.BS.tabfix = function (t) {
        p(t || '[data-bs-toggle="modal"]').on("click", function () {
            var t = p(this), e = t.data("target"), n = t.attr("href"), t = t.data("tab-target"),
                e = e ? a.find(e) : a.find(n);
            t && "#" !== t && e ? e.find('[href="' + t + '"]').tab("show") : e && (n = e.find(".nk-nav.nav-tabs"), t = p(n[0]).find('[data-bs-toggle="tab"]'), p(t[0]).tab("show"))
        })
        ...
        var n, a;
        p(t).exists() && "function" == typeof p.fn.knob && (n = {min: 0}, a = e ? f(n, e) : n, p(t).each(function () {
            p(this).knob(a)
        }))
        ...
        p(t).exists() && "undefined" != typeof noUiSlider && p(t).each(function () {
            var t = p(this), e = t.attr("id"), n = t.data("start"), n = (n = /\s/g.test(n) ? n.split(" ") : n) || 0,
                a = t.data("connect"), a = void 0 === (a = /\s/g.test(a) ? a.split(" ") : a) ? "lower" : a,
                i = t.data("min") || 0, o = t.data("max") || 100, s = t.data("min-distance") || null,
                r = t.data("max-distance") || null, c = t.data("step") || 1, l = t.data("orientation") || "horizontal",
                t = t.data("tooltip") || !1, e = (console.log(t), document.getElementById(e)), n = {
                    start: n,
                    connect: a,
        ...
        p(t).exists() && p(t).each(function () {
            ...
            } : {type: "image", mainClass: "mfp-fade image-popup"}, t = n ? f(t, n) : t;
        ...
        0 < t.length && t.forEach(function (t, e) {
            ...
            u.Custom.Stepper(t, n), u.Validate.OnChange(".js-select2"), u.Validate.OnChange(".date-picker"), u.Validate.OnChange(".js-tagify")
        })
    }, u.Stepper.init = function () {
        u.Stepper(".stepper-init")
    }, u.Tagify = function (t, e) {
        p(t).exists() && "function" == typeof p.fn.tagify && (e = e ? f(void 0, e) : void 0, p(t).tagify(e))
    }, u.Tagify.init = function () {
        u.Tagify(".js-tagify")
    }, u.Filter = function (t, e) {
        document.querySelectorAll(t).forEach(function (t) {
            var n, a;
            void 0 !== t && null != t && (n = new Isotope(t, {
                itemSelector: e,
                layoutMode: "fitRows",
                filter: function (t) {
                    return !0
            ...
            }), a = document.querySelectorAll("[data-filter]"), console.log(), a.forEach(function (e) {
                e.addEventListener("click", function (t) {
                    matchesSelector(t.target, "button") && (t = t.target.getAttribute("data-filter"), n.arrange({filter: t}), a.forEach(function (t) {
        ...
        u.ClassBody(), u.PassSwitch(), u.CurrentLink(), u.LinkOff(".is-disable"), u.ClassNavMenu(), u.SetHW("[data-height]", "height"), u.SetHW("[data-width]", "width"), u.NumberSpinner(), u.Lightbox(".popup-video", "video"), u.Lightbox(".popup-iframe", "iframe"), u.Lightbox(".popup-image", "image"), u.Lightbox(".popup-content", "content"), u.Control(".custom-control-input"), u.Filter(".filter-container", ".filter-item")
    }, u.Ani.init = function () {
        u.Ani.formElm(".form-control-outlined"), u.Ani.formSearch(".toggle-search")
    }, u.BS.init = function () {
        u.BS.menutip("a.nk-menu-link"), u.BS.tooltip(".nk-tooltip"), u.BS.tooltip(".btn-tooltip", {placement: "top"}), u.BS.tooltip('[data-toggle="tooltip"]'), u.BS.tooltip('[data-bs-toggle="tooltip"]'), u.BS.tooltip(".tipinfo,.nk-menu-tooltip", {placement: "right"}), u.BS.popover('[data-toggle="popover"]'), u.BS.popover('[data-bs-toggle="popover"]'), u.BS.progress("[data-progress]"), u.BS.fileinput(".form-file-input"), u.BS.modalfix(), u.BS.ddfix(), u.BS.tabfix()
        ...
        u.Knob.init(), u.Range.init(), u.Select2.init(), u.Dropzone.init(), u.Slider.init(), u.DataTable.init(), u.Tagify.init()
    }, u.TGL.init = function () {
        u.TGL.content(".toggle"), u.TGL.expand(".toggle-expand"), u.TGL.expand(".toggle-opt", {toggle: !1}), u.TGL.showmenu(".nk-nav-toggle"), u.TGL.ddmenu("." + t + "-toggle", {
            self: t + "-toggle",
            child: t + "-sub"
        })
